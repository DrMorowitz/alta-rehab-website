...
export const Component = () => {
  ...
  useEffect(() => {
    ...
    if (audio) {
      ...
      const handleError = (e) => {
        console.warn('Audio file not available - running in demo mode');
        setIsLoading(false);
      };
  ...
  return (
    <div className="music-reactive-hero">
      ...
      <div className="hero-content flex flex-col items-center justify-center h-full w-full text-center" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }}>
        <p
          className="hero-top-phrase"
          style={{
            fontFamily: 'Inter, Montserrat, Nunito, Arial, sans-serif',
            fontWeight: 300,
            color: '#ECE6D8',
            fontSize: '1rem',
            lineHeight: 1.2,
        ...
        >
          REHABILITACIÓN<br />SIN<br />LÍMITES
        </h1>
        <p
          className="hero-bottom-phrase"
          style={{
            fontFamily: 'Inter, Montserrat, Nunito, Arial, sans-serif',
            fontWeight: 300,
            color: '#ECE6D8',
